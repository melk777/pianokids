...
Gerado em 2026-09-26T04:49:11.318Z. Esta auditoria verifica a existencia e a consistencia do registro de procedencia; ela nao substitui parecer juridico individual.
...
| A Deus Demos Glória | William H. Doane | Public Domain | published | documented | - |
...
| Abre Meus Olhos | Clara H. Scott | Public Domain | published | documented | - |
| Alegria ao Mundo | arr. Lowell Mason | Public Domain | published | documented | - |
...
| Anjos das Alturas | Henry Smart | Public Domain | published | documented | - |
...
| Prelúdio em Dó Maior (BWV 846) | Johann Sebastian Bach | Public Domain | pending_owner_review | documented | - |
| Balada nº 4 em Fá Menor | Frédéric Chopin | Public Domain | pending_owner_review | documented | - |
| Bella Ciao | Tradicional italiana | Traditional folk melody; Pianify notation derived from a CC0 LilyPond edition; no television-series arrangement or branding | pending_owner_review | documented | - |
| Borboletinha | Folclore Brasileiro | Public Domain (traditional Brazilian children's song); third-party reference files are not redistributed | pending_owner_review | documented | - |
| Brilha Brilha Estrelinha | Tradicional | Public Domain | pending_owner_review | documented | - |
| Carneirinho, Carneirão | Tradicional | Public Domain (traditional Brazilian circle song); third-party references are not redistributed | pending_owner_review | documented | - |
| Castelo Forte | Martinho Lutero | Public Domain | pending_owner_review | documented | - |
...
| Comigo Habita | William H. Monk | Public Domain | published | documented | - |
| Como um Pastor | William B. Bradbury | Public Domain | published | documented | - |
...
| Doxologia | Louis Bourgeois | Public Domain | published | documented | - |
| Eis dos Anjos a Harmonia | Felix Mendelssohn | Public Domain | published | documented | - |
...
| Formoso Senhor Jesus | Melodia silesiana | Public Domain | published | documented | - |
...
| Fui no Itororó | Tradicional | Public Domain (musical work and 1930 edition); BnF scan retained as external research reference only | pending_owner_review | documented | - |
...
| Guiado pela Mão | William B. Bradbury | Public Domain | published | documented | - |
...
| Jesus Chama | William H. Jude | Public Domain | published | documented | - |
| Jubiloso, Te Adoramos | Henry van Dyke / Beethoven | Public Domain | pending_owner_review | documented | - |
| Junto ao Rio | Robert Lowry | Public Domain | published | documented | - |
| Louvai ao Senhor, Rei Poderoso | Stralsund Gesangbuch | Public Domain | published | documented | - |
| Mais Amor a Ti | William H. Doane | Public Domain | published | documented | - |
...
| Mil Línguas Eu Quisera Ter | Carl G. Gläser | Public Domain | published | documented | - |
| Minha Fé Contempla a Ti | Lowell Mason | Public Domain | published | documented | - |
...
| Sonata ao Luar (1º Movimento) | Ludwig van Beethoven | Creative Commons Attribution-ShareAlike 2.5 | pending_owner_review | documented | - |
| Oração da Manhã | Piotr Ilitch Tchaikovsky | Public Domain | pending_owner_review | documented | - |
| Noturno Op. 9 nº 2 | Frédéric Chopin | Creative Commons Attribution-ShareAlike 3.0 | pending_owner_review | documented | - |
...
| Ó Deus, Nosso Socorro | William Croft | Public Domain | published | documented | - |
| O Primeiro Natal | Tradicional inglês | Public Domain | published | documented | - |
...
| Oh! Que Belas Laranjas | Tradicional | Public Domain (traditional Brazilian circle song); modern recordings and arrangements are not bundled | pending_owner_review | documented | - |
| Canção Francesa Antiga | Piotr Ilitch Tchaikovsky | Public Domain | pending_owner_review | documented | - |
| Onde Está a Margarida? | Tradicional | Public Domain (traditional Brazilian call-and-response circle song) | pending_owner_review | documented | - |
| Pai Francisco | Tradicional | Public Domain (traditional Brazilian circle song) | pending_owner_review | documented | - |
| Parabéns pra Você | Tradicional | Public Domain melody from Good Morning to All (1893); instrumental only; Portuguese lyrics are not bundled | pending_owner_review | documented | - |
| Passarinho da Lagoa | Tradicional | Public Domain traditional children's round; copyrighted art-song settings are excluded | pending_owner_review | documented | - |
| Peixe Vivo | Tradicional | Public-domain traditional composition and reference arrangement, as marked on the source score | pending_owner_review | documented | - |
| Pezinho | Tradicional | Public Domain (traditional southern Brazilian dance song) | pending_owner_review | documented | - |
| Sonata para Piano em Dó Maior, KV 309 (1ª Parte) | Wolfgang Amadeus Mozart | Public Domain | pending_owner_review | documented | - |
| Pirulito que Bate Bate | Tradicional | Public Domain (traditional Brazilian children's song) | pending_owner_review | documented | - |
| Prelúdio Op. 28 nº 4 | Frédéric Chopin | Public Domain | pending_owner_review | documented | - |
| Prelúdio Op. 45 | Frédéric Chopin | Public Domain | pending_owner_review | documented | - |
| Prelúdio nº 15 | Frédéric Chopin | Public Domain | pending_owner_review | documented | - |
| Prelúdio nº 20 | Frédéric Chopin | Public Domain | pending_owner_review | documented | - |
...
| Que Segurança | Phoebe P. Knapp | Public Domain | published | documented | - |
...
| Sapo Cururu | Tradicional | Public Domain | pending_owner_review | documented | - |
| Se Essa Rua Fosse Minha | Tradicional | Public Domain (traditional song documented in the nineteenth century) | pending_owner_review | documented | - |
...
| Sou Teu, Senhor | William H. Doane | Public Domain | published | documented | - |
...
| Tal Qual Estou | William B. Bradbury | Public Domain | published | documented | - |
...
| As Estações: Fevereiro | Piotr Ilitch Tchaikovsky | Public Domain | pending_owner_review | documented | - |
| As Estações: Janeiro | Piotr Ilitch Tchaikovsky | Public Domain | pending_owner_review | documented | - |
| Tocata e Fuga em Ré Menor | Johann Sebastian Bach | Public Domain | pending_owner_review | documented | - |
...
| Vem, Tu, Onipotente | Felice de Giardini | Public Domain | published | documented | - |

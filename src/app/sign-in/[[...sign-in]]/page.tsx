...
export default function SignInPage() {
  return (
    <main className="min-h-screen bg-[#0a0a0a] flex items-center justify-center relative overflow-hidden p-6">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-gradient-to-tr from-cyan/10 via-transparent to-magenta/10 blur-[130px] rounded-full pointer-events-none" />
        ...
        <SignIn 
          appearance={{
            ...
            variables: {
              colorPrimary: "#00eaff",
              colorText: "#ffffff",
              colorBackground: "transparent", // Mantém transparente para revelar o glassmorphism do card
            }
          }}
        />
      </div>

        ...
        >
              ...
              {midiStatus === "connecting" ? (
                ...
                <>
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                    <path d="M13.3 4.3L6.3 11.3L2.7 7.7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
                  </svg>
                  Conectado! ({devices.length} dispositivo{devices.length !== 1 ? "s" : ""})
                </>
              ) : (
                <>
          ...
          {!isSupported && (
            <p className="mt-4 text-xs text-white/30">
              WebMIDI não suportado neste navegador. Recomendamos Chrome ou Edge.
            </p>
          )}
        </motion.div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <p className="text-white/40 max-w-lg mx-auto">
              Uma experiência projetada para manter crianças engajadas e aprendendo.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                icon: (
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                    <path d="M12 20V10M6 20V4M18 20v-4" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                ),
